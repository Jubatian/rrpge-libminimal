...
/* User Library font */
static const uint8 rrpge_m_ires_font[3072] = {
...
void rrpge_m_ires_init(rrpge_object_t* obj)
{
 ...
 /* 0xFC800 - 0xFDFFF: User Library font */
 for (i = 0U; i < 3072U; i++){
  r = rrpge_m_ires_font[i];
  p[0xFC800U + i] |= ((r & 0x80U) << 21) | /* Normal 4 bit font */
                     ((r & 0x40U) << 18) |
                     ((r & 0x20U) << 15) |
                     ((r & 0x10U) << 12) |
                     ((r & 0x08U) <<  9) |
                     ...
                     ((r & 0x02U) <<  3) |
                     ((r & 0x01U)      );
  p[0xFC800U + i] |= (((~r) & 0x80U) << 23) | /* Inverted 4 bit font */
                     (((~r) & 0x40U) << 20) |
                     (((~r) & 0x20U) << 17) |
                     (((~r) & 0x10U) << 14) |
                     (((~r) & 0x08U) << 11) |
                     ...
                     (((~r) & 0x02U) <<  5) |
                     (((~r) & 0x01U) <<  2);
  p[0xFC800U + (i << 1) + 0U] |= ((r & 0x80U) << 18) | /* Normal 8 bit font */
                                 ((r & 0x40U) << 11) |
                                 ((r & 0x20U) <<  4) |
                                 ((r & 0x10U) >>  3);
  p[0xFC800U + (i << 1) + 1U] |= ((r & 0x08U) << 22) |
                                 ((r & 0x04U) << 15) |
                                 ((r & 0x02U) <<  8) |
                                 ((r & 0x01U) <<  1);
  p[0xFC800U + (i << 1) + 0U] |= (((~r) & 0x80U) << 22) | /* Inverted 8 bit font */
                                 (((~r) & 0x40U) << 15) |
                                 (((~r) & 0x20U) <<  8) |
                                 (((~r) & 0x10U) <<  1);
  p[0xFC800U + (i << 1) + 1U] |= (((~r) & 0x08U) << 26) |
                                 (((~r) & 0x04U) << 19) |
                                 (((~r) & 0x02U) << 12) |
                                 (((~r) & 0x01U) <<  5);
 }
